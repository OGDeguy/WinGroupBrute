...
WinGroupBrute is a script that takes a supplied user and attempts to add it to all local groups and domain groups (with the --domain flag). This script is not stealthy.
